...
Repos created off of this template will follow the naming convention `terraform-aws-sqs-module-module`, replacing sqs-module with the name of your module.
